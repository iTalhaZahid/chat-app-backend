export const Verification_Email_Template = `
  ...
  <body>
      <div class="container">
          ...
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} ChatX. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              ...
              <span class="verification-code">{verificationCode}</span>
              <p>If you did not request a password reset, no further action is required. If you have any questions, feel free to contact our support team.</p>
          </div>
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} ChatX. All rights reserved.</p>
          </div>
